...
HEADER_ALIASES: dict[str, tuple[str, ...]] = {
    ...
    "purpose": ("purpose", "application", "use", "finalidade", "aplicacao", "uso", "用途"),
    "dimensions": ("dimensions", "dimension", "measurements", "dimensoes", "medidas", "尺寸"),
    "weight": ("weight", "peso", "重量"),
    "capacity": ("capacity", "capacidade", "容量"),
    "voltage": ("voltage", "tensao", "voltagem", "电压"),
    "power": ("power", "potencia", "功率"),
    "frequency": ("frequency", "frequencia", "频率"),
    "battery": ("battery", "battery type", "bateria", "tipo de bateria", "电池"),
    "recharge": ("recharge", "charging", "charge", "recarga", "carregamento", "充电"),
    "connection": ("connection", "connectivity", "connector", "conexao", "conector", "连接"),
    "accessories": ("accessories", "included accessories", "acessorios", "itens inclusos", "配件"),
